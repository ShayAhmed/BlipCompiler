...
#ifndef PROJECT_8_INTERPRETER_A_STRING_H
#define PROJECT_8_INTERPRETER_A_STRING_H
#ifndef _String_h
#define _String_h
#include <stdlib.h>
#include <stdint.h>
...
public:
    ...
    int stringToInt(String convertThis){
        return atoi(convertThis.c_str()); // CONVERTS STRING TO INT
    }
...
#endif //PROJECT_8_INTERPRETER_A_STRING_H
